...
import { generateFutureSelf, askFutureSelf } from "./services/futureSelfApi";
import {
...
function App() {
  ...
  const handleChoice = (choice) => {
    ...
    try {
      ...
      setFutureSelfError(
        error?.message || "Unable to apply this decision.",
      );
    }
  };
  ...
  const handleContinue = async () => {
    /*
     * No decision has been selected yet.
     */
    if (!selectedChoice) {
      return;
    }
     ...
     * Generate the player's Future Self.
     */
